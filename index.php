   ...
   <div class="row m-0">
      ...
      <div class="col-md-12 p-0">
         <div class="tutor-slider1 owl-carousel">
               ...
               <a class="t-grid" href="#">
                  <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/hd1.png">
                  <h4>Christelle H</h4>
                  <div class="starsec">
                  ...
                  <div class="dt-price">
                     <div class="lft-price">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/time.png">
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/loc1.png">
                        <h3>$455 <span>$3499</span></h3>
                     </div>
                     <div class="pr-tag">
                        <img class="tg1" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/tag1.png">
                        <img class="tg2" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/tag2.png">
                     </div>
                  </div>
               </a>            
               <a class="t-grid" href="#">
                  <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/hd2.png">
                  <h4>Christelle H</h4>
                  <div class="starsec">
                     <span class="fa fa-star"></span>
                     <span class="fa fa-star"></span>
               ...
               <a class="t-grid" href="#">
                  <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/hd3.png">
                  <h4>Nancy O</h4>
                  <div class="starsec">
                     <span class="fa fa-star"></span>
                     <span class="fa fa-star"></span>
               ...
               <a class="t-grid" href="#">
                  <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/hd5.png">
                  <h4>Anushri S</h4>
                  <div class="starsec">
                     <span class="fa fa-star"></span>
                     <span class="fa fa-star"></span>
               ...
               <a class="t-grid" href="#">
                  <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/hd6.png">
                  <h4>Pouya M</h4>
                  <div class="starsec">
                     <span class="fa fa-star"></span>
                     <span class="fa fa-star"></span>
               ...
               <a class="t-grid" href="#">
                  <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/hd7.png">
                  <h4>Monique R</h4>
                  <div class="starsec">
                     <span class="fa fa-star"></span>
                     <span class="fa fa-star"></span>
